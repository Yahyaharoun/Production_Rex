    ...
    <div className="min-h-screen flex items-center justify-center bg-slate-50 p-4">
      <div className="w-full max-w-sm space-y-6 bg-white p-8 rounded-[2rem] shadow-2xl border border-border animate-in fade-in zoom-in duration-500">
        <div className="space-y-4 text-center">
          ...
          <h1 className="text-2xl font-black tracking-tighter text-foreground">AccÃ¨s Restreint</h1>
          <p className="text-muted-foreground text-sm font-bold">
            La crÃ©ation de compte est rÃ©servÃ©e Ã  l'administrateur du systÃ¨me Production Rex.
          </p>
          <div className="p-4 bg-secondary/30 rounded-xl border border-border/50">
            <p className="text-xs text-muted-foreground font-medium italic">
              Veuillez contacter votre chef d'agence ou la direction gÃ©nÃ©rale (PDG) pour obtenir vos identifiants de connexion.
            </p>
          </div>
        </div>
